...
asm(".set LOAD_SECTORS,0x3f");// 31½K (the whole 1st cylinder)
...
asm("  .long tsk13,0x000ad980,0x00000000,0x00000000, 0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000,0x00000000");
